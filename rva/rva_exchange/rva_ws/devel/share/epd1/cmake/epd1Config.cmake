...
if("TRUE" STREQUAL "TRUE")
  set(epd1_SOURCE_PREFIX /home/rva_container/rva_exchange/rva_ws/src/epd1)
  set(epd1_DEVEL_PREFIX /home/rva_container/rva_exchange/rva_ws/devel)
  set(epd1_INSTALL_PREFIX "")
  set(epd1_PREFIX ${epd1_DEVEL_PREFIX})
else()
  set(epd1_SOURCE_PREFIX "")
  set(epd1_DEVEL_PREFIX "")
  set(epd1_INSTALL_PREFIX /home/rva_container/rva_exchange/rva_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'epd1' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rva_container/rva_exchange/rva_ws/src/epd1/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT epd1_NUM_DUMMY_TARGETS)
      set(epd1_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::epd1::wrapped-linker-option${epd1_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR epd1_NUM_DUMMY_TARGETS "${epd1_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::epd1::wrapped-linker-option${epd1_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND epd1_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(epd1_EXPORTED_TARGETS ${${epd1_dep}_EXPORTED_TARGETS})
endforeach()
