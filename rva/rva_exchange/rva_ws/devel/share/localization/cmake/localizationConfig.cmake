...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/rva_container/rva_exchange/rva_ws/src/localization)
  set(localization_DEVEL_PREFIX /home/rva_container/rva_exchange/rva_ws/devel)
  ...
  set(localization_INSTALL_PREFIX /home/rva_container/rva_exchange/rva_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rva_container/rva_exchange/rva_ws/src/localization/${idir}'.  ${_report}")
    endif()
